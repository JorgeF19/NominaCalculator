document.addEventListener("DOMContentLoaded", function () {
  let arrayDatos = {
    ...
    variable: [parseFloat(localStorage.getItem("variable")), "fila-var"],
    auxilioTransporte: [
  ...
  let arrayValoresID = {
    ...
    variableID: ["variable-valor", arrayFormateado.variable],
  ...
  console.log("Valores de la tabla: " + arrayValoresID);
